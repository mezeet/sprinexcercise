...
public class NoticeDaoProvider {
	...
	private static NoticeDaoProvider instance
	= new NoticeDaoProvider();
...
//		("MessageDaoProvider.getInstance()");
	...
	private MySQLNoticeDao mysqlDao 
	= new MySQLNoticeDao();
	private OracleNoticeDao oracleDao 
	= new OracleNoticeDao();
	private MSSQLNoticeDao mssqlDao 
	= new MSSQLNoticeDao();
