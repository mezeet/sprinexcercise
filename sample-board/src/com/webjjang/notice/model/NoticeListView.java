package com.webjjang.notice.model;
...
public class NoticeListView {
	...
	public NoticeListView(int totalRow, int totalPage,
			int startRow, int endRow, int startPage,
			int endPage, int page,
			int rowPerPage, int pagePerGroup,
			List<Notice> list, String searchKey, String searchWord, String period){
	...
	private String searchKey, searchWord, period;
