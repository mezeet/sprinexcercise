...
public class MemberUpdateProcessService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("BoardUpdateProcessService.process()");
		String uploadPath
...
//				System.out.println("서버파일:"+serverFile);
		...
		try {
			...
			if(fileList!=null && fileList.size()>0){
				...
				dao.increaseTarget(con, "board", "fileCount", no, board.getFileList().size());
			}
			con.commit();
